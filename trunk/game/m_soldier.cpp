...
void soldier_cock (edict_t *self)
{
	if (self->s.frame == FRAME_stand322)
		Sound (self, CHAN_WEAPON, sound_cock, 1, ATTN_IDLE, 0);
	else
		Sound (self, CHAN_WEAPON, sound_cock);
}
...
void soldier_pain (edict_t *self, edict_t *other, float kick, int damage)
{
	...
	n = self->s.skinNum | 1;
	if (n == 1)
		Sound (self, CHAN_VOICE, sound_pain_light);
	else if (n == 3)
		Sound (self, CHAN_VOICE, sound_pain);
	else
		Sound (self, CHAN_VOICE, sound_pain_ss);
...
{
	if (random() < 0.5)
		Sound (self, CHAN_VOICE, sound_sight1);
	else
		Sound (self, CHAN_VOICE, sound_sight2);
...
// regular death
	...
	if (self->s.skinNum == 1)
		Sound (self, CHAN_VOICE, sound_death_light);
	else if (self->s.skinNum == 3)
		Sound (self, CHAN_VOICE, sound_death);
	else // (self->s.skinnum == 5)
		Sound (self, CHAN_VOICE, sound_death_ss);
