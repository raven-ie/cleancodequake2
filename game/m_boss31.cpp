...
void jorg_search (edict_t *self)
{
	...
	if (r <= 0.3)
		Sound (self, CHAN_VOICE, sound_search1);
	else if (r <= 0.6)
		Sound (self, CHAN_VOICE, sound_search2);
	else
		Sound (self, CHAN_VOICE, sound_search3);
}
...
void jorg_idle (edict_t *self)
{
	Sound (self, CHAN_VOICE, sound_idle, 1, ATTN_NORM,0);
}

void jorg_death_hit (edict_t *self)
{
	Sound (self, CHAN_BODY, sound_death_hit, 1, ATTN_NORM,0);
}
...
void jorg_pain (edict_t *self, edict_t *other, float kick, int damage)
{
	...
	*/
	...
	if (damage <= 50)
	{
		Sound (self, CHAN_VOICE, sound_pain1, 1, ATTN_NORM,0);
		self->monsterinfo.currentmove = &jorg_move_pain1;
	}
	else if (damage <= 100)
	{
		Sound (self, CHAN_VOICE, sound_pain2, 1, ATTN_NORM,0);
	...
	else
	{
		if (random() <= 0.3)
		{
			Sound (self, CHAN_VOICE, sound_pain3, 1, ATTN_NORM,0);
...
void jorgBFG (edict_t *self)
{
	...
	Sound (self, CHAN_VOICE, sound_attack2);
...
void jorg_attack(edict_t *self)
{
	...
	if (random() <= 0.75)
	{
		Sound (self, CHAN_VOICE, sound_attack1, 1, ATTN_NORM,0);
		self->s.sound = gi.soundindex ("boss3/w_loop.wav");
		self->monsterinfo.currentmove = &jorg_move_start_attack1;
	}
	else
	{
		Sound (self, CHAN_VOICE, sound_attack2, 1, ATTN_NORM,0);
