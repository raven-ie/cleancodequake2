...
void mutant_step (edict_t *self)
{
	...
	n = (rand() + 1) % 3;
	if (n == 0)
		Sound (self, CHAN_VOICE, sound_step1);		
	else if (n == 1)
		Sound (self, CHAN_VOICE, sound_step2);
	else
		Sound (self, CHAN_VOICE, sound_step3);
}
...
{
	Sound (self, CHAN_VOICE, sound_search);
}

void mutant_swing (edict_t *self)
{
	Sound (self, CHAN_VOICE, sound_swing);
}
...
void mutant_idle (edict_t *self)
{
	...
	Sound (self, CHAN_VOICE, sound_idle, 1, ATTN_IDLE, 0);
}
...
void mutant_hit_left (edict_t *self)
{
	...
	if (fire_hit (self, aim, (10 + (rand() %5)), 100))
		Sound (self, CHAN_WEAPON, sound_hit);
	else
		Sound (self, CHAN_WEAPON, sound_swing);
}
...
void mutant_hit_right (edict_t *self)
{
	...
	if (fire_hit (self, aim, (10 + (rand() %5)), 100))
		Sound (self, CHAN_WEAPON, sound_hit2);
	else
		Sound (self, CHAN_WEAPON, sound_swing);
}
...
void mutant_check_landing (edict_t *self)
{
	if (self->groundentity)
	{
		Sound (self, CHAN_WEAPON, sound_thud);
