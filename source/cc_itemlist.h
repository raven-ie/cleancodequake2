...
typedef std::multimap<size_t, size_t, std::less<size_t>, std::generic_allocator<size_t> > THashedItemListType;
typedef std::vector<CBaseItem*, std::generic_allocator<CBaseItem*> > TItemListType;
// Generic itemlist.
class CItemList
{
public:
