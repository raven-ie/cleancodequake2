...
#if (!defined(CC_GUARD_PATHFINDING_H) || !INCLUDE_GUARDS)
#define CC_GUARD_PATHFINDING_H
enum ENodeType
{
	NODE_REGULAR,
...
typedef std::vector<CPathNode*, std::allocator<CPathNode*> > TPathNodeChildrenContainer;
