...
void AddKeysToList ()
{
	NItems::DataCD = QNew (com_gamePool, 0) CKey("key_data_cd", "models/items/keys/data_cd/tris.md2", EF_ROTATE, "items/pkup.wav", "k_datacd", "Data CD", ITEMFLAG_GRABBABLE|ITEMFLAG_KEY|ITEMFLAG_STAY_COOP, "");
	...
	NItems::PyramidKey = QNew (com_gamePool, 0) CKey("key_pyramid", "models/items/keys/pyramid/tris.md2", EF_ROTATE, "items/pkup.wav", "k_pyramid", "Pyramid Key", ITEMFLAG_GRABBABLE|ITEMFLAG_KEY|ITEMFLAG_STAY_COOP, "");
	NItems::DataSpinner = QNew (com_gamePool, 0) CKey("key_data_spinner", "models/items/keys/spinner/tris.md2", EF_ROTATE, "items/pkup.wav", "k_dataspin", "Data Spinner", ITEMFLAG_GRABBABLE|ITEMFLAG_KEY|ITEMFLAG_STAY_COOP, "");
	NItems::SecurityPass = QNew (com_gamePool, 0) CKey("key_pass", "models/items/keys/pass/tris.md2", EF_ROTATE, "items/pkup.wav", "k_security", "Security Pass", ITEMFLAG_GRABBABLE|ITEMFLAG_KEY|ITEMFLAG_STAY_COOP, "");
	NItems::BlueKey = QNew (com_gamePool, 0) CKey("key_blue_key", "models/items/keys/key/tris.md2", EF_ROTATE, "items/pkup.wav", "k_bluekey", "Blue Key", ITEMFLAG_GRABBABLE|ITEMFLAG_KEY|ITEMFLAG_STAY_COOP, "");
