...
public:
	...
	bool				Open ()
	{
		...
		CMenu_Label *TopGreen = new CMenu_Label(this, x, y);
		...
		CCloseLabel *Back = new CCloseLabel (this, x, y);
		Back->Enabled = true;
...
public:
	...
	bool				Open ()
	{
		...
		CMenu_Image *Background = new CMenu_Image (this, x, y);
		...
		y = -76; // Top
		CMenu_Label *TopName = new CMenu_Label(this, x, y);
		...
		y += (8 * 2);
		CMenu_Label *LevelName = new CMenu_Label(this, x, y);
		...
		case MATCH_SETUP :
			MatchProgress = new CMenu_Label(this, x, y);
		...
		{
			CMenu_Label *LockedMsg = new CMenu_Label(this, x, y);
		...
		else if (ctf_forcejoin->String() && *ctf_forcejoin->String())
		{
			...
			{
				// Only add red
				CJoinGameLabel *JoinRed = new CJoinGameLabel(this, x, y, CTF_TEAM1);
			...
			{
				// Only add blue
				CJoinGameLabel *JoinBlue = new CJoinGameLabel(this, x, y + 8, CTF_TEAM2);
		...
		y += 8;
		CCreditsLabel *Credits = new CCreditsLabel(this, x, y);
