...
bool CWeaponItem::Pickup (class CItemEntity *Player, CPlayerEntity *Other)
{
	...
	if (!(Player->SpawnFlags & DROPPED_ITEM) )
	{
		...
		Ammo->AddAmmo (Other, Player->AmmoCount);
...
bool CAmmo::Pickup (class CItemEntity *Player, CPlayerEntity *Other)
{
	...
	if (!(Player->SpawnFlags & (DROPPED_ITEM | DROPPED_PLAYER_ITEM)) && (Game.GameMode & GAME_DEATHMATCH))
		SetRespawn (Player, 300);
	return true;
}
...
bool CAmmoWeapon::Pickup (class CItemEntity *Player, CPlayerEntity *Other)
{
...
void AddAmmoToList ()
{
	NItems::Shells = QNew (TAG_GAME) CAmmo("ammo_shells", "models/items/ammo/shells/medium/tris.md2", 0, "misc/am_pkup.wav", "a_shells", "Shells", ITEMFLAG_DROPPABLE|ITEMFLAG_AMMO|ITEMFLAG_GRABBABLE, "", 10, CAmmo::AMMOTAG_SHELLS);
	NItems::Bullets = QNew (TAG_GAME) CAmmo("ammo_bullets", "models/items/ammo/bullets/medium/tris.md2", 0, "misc/am_pkup.wav", "a_bullets", "Bullets", ITEMFLAG_DROPPABLE|ITEMFLAG_AMMO|ITEMFLAG_GRABBABLE, "", 50, CAmmo::AMMOTAG_BULLETS);
	NItems::Slugs = QNew (TAG_GAME) CAmmo("ammo_slugs", "models/items/ammo/slugs/medium/tris.md2", 0, "misc/am_pkup.wav", "a_slugs", "Slugs", ITEMFLAG_DROPPABLE|ITEMFLAG_AMMO|ITEMFLAG_GRABBABLE, "", 10, CAmmo::AMMOTAG_SLUGS);
	NItems::Grenades = QNew (TAG_GAME) CAmmoWeapon("ammo_grenades", "models/items/ammo/grenades/medium/tris.md2", 0, "misc/am_pkup.wav", "a_grenades", "Grenades", ITEMFLAG_DROPPABLE|ITEMFLAG_AMMO|ITEMFLAG_USABLE|ITEMFLAG_GRABBABLE|ITEMFLAG_WEAPON, "", &CHandGrenade::Weapon, 1, "#a_grenades.md2", 5, CAmmo::AMMOTAG_GRENADES);
	NItems::Rockets = QNew (TAG_GAME) CAmmo("ammo_rockets", "models/items/ammo/rockets/medium/tris.md2", 0, "misc/am_pkup.wav", "a_rockets", "Rockets", ITEMFLAG_DROPPABLE|ITEMFLAG_AMMO|ITEMFLAG_GRABBABLE, "", 5, CAmmo::AMMOTAG_ROCKETS);
	NItems::Cells = QNew (TAG_GAME) CAmmo("ammo_cells", "models/items/ammo/cells/medium/tris.md2", 0, "misc/am_pkup.wav", "a_cells", "Cells", ITEMFLAG_DROPPABLE|ITEMFLAG_AMMO|ITEMFLAG_GRABBABLE, "", 50, CAmmo::AMMOTAG_CELLS);
