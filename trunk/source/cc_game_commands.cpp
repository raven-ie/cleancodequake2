...
// Arcade Quake II
class CArcadeQ2AimCommand : public CGameCommandFunctor
{
public:
	void operator () ()
	{
		if (ArgCount() < 2)
		{
			Player->Client.Respawn.AimDegrees = 0;
			return;
		}
		...
		Player->Client.Respawn.AimDegrees = ArgGetf (1);
	};
};

class CArcadeQ2CamDistCommand : public CGameCommandFunctor
{
public:
	void operator () ()
	{
		...
		Player->Client.Respawn.CameraDistance = arg;
	};
};
// Arcade Quake II
...
void Cmd_Register ()
{
	...
	// Arcade Quake II
	Cmd_AddCommand<CArcadeQ2CamDistCommand> ("camdist");
	Cmd_AddCommand<CArcadeQ2AimCommand> ("aim");
	// Arcade Quake II
