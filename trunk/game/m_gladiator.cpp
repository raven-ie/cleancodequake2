...
{
	Sound (self, CHAN_WEAPON, sound_cleaver_swing);
}
...
void GaldiatorMelee (edict_t *self)
{
	...
	if (fire_hit (self, aim, (20 + (rand() %5)), 300))
		Sound (self, CHAN_AUTO, sound_cleaver_hit);
	else
		Sound (self, CHAN_AUTO, sound_cleaver_miss);
}
...
void gladiator_attack(edict_t *self)
{
	...
	Sound (self, CHAN_WEAPON, sound_gun);
