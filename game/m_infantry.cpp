...
{
	Sound (self, CHAN_BODY, sound_sight);
}
...
// regular death
	...
	if (n == 0)
	{
		...
		Sound (self, CHAN_VOICE, sound_die2);
	}
	else if (n == 1)
	{
		self->monsterinfo.currentmove = &infantry_move_death2;
		Sound (self, CHAN_VOICE, sound_die1);
	}
	else
	{
...
void infantry_cock_gun (edict_t *self)
{
	...
	Sound (self, CHAN_WEAPON, sound_weapon_cock);
	n = (rand() & 15) + 3 + 7;
...
{
	Sound (self, CHAN_WEAPON, sound_punch_swing);
}
...
void infantry_smack (edict_t *self)
{
	...
	if (fire_hit (self, aim, (5 + (rand() % 5)), 50))
		Sound (self, CHAN_WEAPON, sound_punch_hit);
}
