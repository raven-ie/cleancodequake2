...
void AddKeysToList ()
{
	...
	CKey *SecurityPass = new CKey("key_pass", "models/items/keys/pass/tris.md2", EF_ROTATE, "items/pkup.wav", "k_pass", "Security Pass", ITEMFLAG_GRABBABLE|ITEMFLAG_KEY|ITEMFLAG_STAY_COOP, "");
