...
{
	Sound (self, CHAN_WEAPON, sound_launch);
}

void parasite_reel_in (edict_t *self)
{
	Sound (self, CHAN_WEAPON, sound_reelin);
}

void parasite_sight (edict_t *self, edict_t *other)
{
	Sound (self, CHAN_WEAPON, sound_sight);
}

void parasite_tap (edict_t *self)
{
	Sound (self, CHAN_WEAPON, sound_tap, 1, ATTN_IDLE, 0);
}

void parasite_scratch (edict_t *self)
{
	Sound (self, CHAN_WEAPON, sound_scratch, 1, ATTN_IDLE, 0);
}

void parasite_search (edict_t *self)
{
	Sound (self, CHAN_WEAPON, sound_search, 1, ATTN_IDLE, 0);
}
...
void parasite_drain_attack (edict_t *self)
{
	...
	{
		damage = 5;
		Sound (self->enemy, CHAN_AUTO, sound_impact);
	}
	else
	{
		if (self->s.frame == FRAME_drain04)
			Sound (self, CHAN_WEAPON, sound_suck);
		damage = 2;
	}
